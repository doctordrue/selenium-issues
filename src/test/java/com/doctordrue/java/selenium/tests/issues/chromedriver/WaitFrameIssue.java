...
public class WaitFrameIssue extends BaseTestNGTest {
   ...
   public void openJsFiddle() {
      ...
      new WebDriverWait(driver, Duration.of(10, ChronoUnit.SECONDS)).until(ExpectedConditions.frameToBeAvailableAndSwitchToIt(0));
   }
   ...
   public void switchToFrameAndFindElement() throws InterruptedException {
      ...
      new WebDriverWait(driver, Duration.of(10, ChronoUnit.SECONDS)).until(ExpectedConditions.frameToBeAvailableAndSwitchToIt("target_iframe"));
